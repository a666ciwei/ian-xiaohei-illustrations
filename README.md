# Ian Hedgehog Illustrations

> 把中文文章里的判断、流程、状态和隐喻，变成一张张白底、手绘、温暖但清爽的正文配图。
>
> 16:9 横版 | 刺猬 IP | 暖白手绘 | 少量红橙蓝中文批注 | Codex Skill

---

## 这个仓库是什么

Ian Hedgehog Illustrations 是一个 Codex Skill，用来指导 AI Agent 为中文文章、帖子、博客、Notion 文档和方法论内容生成正文配图。

它不是通用插画 prompt，也不是 PPT 信息图模板。它的核心目标是：先理解文章里的认知锚点，再把其中一个判断、流程、结构、状态或隐喻，变成一张有记忆点的 16:9 手绘解释图。

默认视觉 IP 是“刺猬”：一个棕色柔软刺毛、米白脸和肚皮、黑豆眼、小圆鼻、橘棕围巾、米白毛衣、橄榄绿裤子和斜挎小包的拟人刺猬角色。刺猬不是吉祥物，不是贴纸，也不是站在角落里的装饰物，而是正在认真参与系统运转的手作内容工作者。
...
- 想把抽象判断画成具体隐喻的人
- 想要一种比 PPT 信息图更轻、更暖、更有个人识别度的配图风格的人
...
这个 skill 默认使用 Ian 的“刺猬温暖手绘正文配图”风格：

- 干净白底或非常浅的暖米白底，不要纸纹、阴影、渐变
- 棕黑色手绘线稿，细线，轻微抖动
- 大量留白，主体只占画面约 40%-60%
- 少量红色、橙色、蓝色中文手写批注
- 一张图只表达一个核心动作、结构、状态或隐喻
- 刺猬必须参与核心动作，不能只是装饰
- 温暖、有创意、清爽，但不低幼、不商业吉祥物化
...
```text
Use $ian-xiaohei-illustrations 为这篇中文文章设计并生成 5 张刺猬温暖手绘正文配图。
```
...
每张图写清楚：放在哪段后、主题、核心意思、结构类型、刺猬在做什么、建议中文标注词。
...
```text
Use $ian-xiaohei-illustrations 把下面这篇文章生成 4 张刺猬温暖手绘正文配图。
要求：16:9 横版、干净白底或非常浅的暖米白底、棕黑色手绘线稿、少量红橙蓝中文手写批注。
...
6. 让刺猬承担核心动作
7. 每张图单独调用图像模型生成
8. 按 QA checklist 检查：白底、留白、刺猬动作、中文标注、非 PPT 感、非旧案例复刻
9. 保存最终 PNG，并报告用途和路径
...
- 刺猬必须承担核心动作；如果去掉刺猬画面仍然完全成立，说明刺猬太装饰了。
- 示例图只用于校准线条密度、留白、颜色克制和刺猬参与方式，不要复刻构图。
...
这套刺猬配图 Skill，只是我用 AI 搭建个人生产系统里的一个小工具。
