...
每张图只讲一个核心结构，不要做 PPT 信息图，不要低幼卡通。
...
```text
Use $ian-xiaohei-illustrations 这张图方向对，但刺猬有点像装饰。
请保持核心意思不变，重生成一版：让刺猬成为真正推动结构运转的人。
画面更温暖一点，但仍然干净、清爽、少字。
```
...
```text
Use $ian-xiaohei-illustrations 输出 5 个不同主题的刺猬正文配图效果。
